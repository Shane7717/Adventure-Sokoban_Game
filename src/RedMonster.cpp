...
RedMonster::RedMonster(BaseEngine *pEngine, int x, int y, CW4TileManager* tileManager)
	: Monster(pEngine, x, y, tileManager) {
	leftImage = ImageManager::loadImage("RedMonsterLeft.png", true);
	rightImage = ImageManager::loadImage("RedMonsterRight.png", true);
	mainImage = leftImage;
	tm = tileManager;
...
void RedMonster::virtDoUpdate(int iCurrentTime){
