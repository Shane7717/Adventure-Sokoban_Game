...
//This will be called whenever the program needs to draw the background
//This is a virtual function that will be called instead of the parent one
void MyDemoA::virtSetupBackgroundBuffer()
{
	...
	//I guess this function will implicitly invoke virtDrawTileAt() for multiple times;
	tm.drawAllTiles(this, getBackgroundSurface());	
}

//Will be called every time there's a mouse down event
